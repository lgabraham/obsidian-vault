...
The following is a search query and a set of unstructured text of products resulting from the search query. Your goal is to create a classifier system to identify the dimensions on which these products vary and classify new products accordingly.
